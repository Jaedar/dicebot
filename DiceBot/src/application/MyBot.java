   ...
   @Override public  void  onPrivateMessage(String sender,String login, String hostname, String message) {
    if(message.startsWith(",")){
      if (message.startsWith(",dlroll")) {
        ...
        sendMessage(sender, sender+" "+d.out());
        return;
      }
      if (message.startsWith(",roll")) {
        Dieroll dd=new Dieroll(message);
        sendMessage(sender, sender+" "+dd.out());
        return;
      }
      ...
      if (message.startsWith(",dldraw")){
        ...
        sendMessage(sender, sender+" "+init.go(message));
        return;
      }
...
//    }
    ...
    if (message.equalsIgnoreCase(",help")) {
      sendMessage(channel, "Read the source code and educate thyself scrub");
    }
    if (message.equalsIgnoreCase(",deso")) {
      ...
      sendMessage(channel, "When I dabbled in programming I saw a gaping abyss staring into my soul and I ran to music");
    }
      ...
      sendMessage(channel, "Now supports dx+y rolls and sums by adding sum after the roll. (Ex: ,roll 2d3+4 sum)");
    }
...
//    }
      ...
      if (message.startsWith(",dldraw")){
        if (message.matches(",dldraw\\s*\\d+")){
          String[] spl=message.split("\\s");
          sendMessage(channel, sender+" : "+dek.draw(Integer.parseInt(spl[1])));
          return;
        }
        else if (message.matches(",dldraw.*"))
  ...
  public String deso(String sender) {
    ...
    switch (rand){
      case 1: str= "I am tired"; 
      break;
      case 2: str= "This headache is annoying";
      break;
      case 3: str= sender+" you fucker";
      break;
      case 4: str = "I am going to take a nap";
      break;
      case 5: str = "I hope you get ass cancer! ";
      break;
      default: System.out.println("Jaedar cannot into programming");
      break; 
    }
    return str;
  }
  ...
  public String alex(String sender) {
    ...
    switch (rand){
      case 1: str= "Hello "+sender+", how are you doing?"; 
      break;
      case 2: str= "Awesome, do you think Burning Wheel has rules for that?";
      break;
      case 3: str= "Hello "+sender+", how is it going?";
      break;
      case 4: str = "I am going to take a nap";
      break;
      default: System.out.println("Jaedar cannot into programming");
  ...
  public String root(String sender) {
    ...
    rand = (int) (5*Math.random()+1);
    switch (rand){
      case 1: str= "Have I ever told you the tragedy of Darth Plagueis the Wise?"; 
      break;
      case 2: str=sender+ ", are you going to scarborough fair? ";
      break;
      case 3: str= sender+", can you hear the clarion call? ";
      break;
      case 4: str = "You're dead to me, "+sender+"! You hear me!? Dead! ";
      break;
      case 5: str = "This channel lacks moral clarity. ";
      break;
      default: System.out.println("Jaedar cannot into programming");
      break; 
    }
